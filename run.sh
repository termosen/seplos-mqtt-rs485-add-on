...
export UPDATE_MODE="$(bashio::config 'update_mode')"
export MQTT_UPDATE_INTERVAL="$(bashio::config 'mqtt_update_interval')"
export ACTIVE_INTERVAL="$(bashio::config 'active_interval')"
export IDLE_INTERVAL="$(bashio::config 'idle_interval')"
export ACTIVE_POWER_THRESHOLD="$(bashio::config 'active_power_threshold')"
